package com.bkw.library.permission.utils;
...
import com.bkw.library.permission.menu.DefaultStartSetting;
import com.bkw.library.permission.menu.IMenu;
import com.bkw.library.permission.menu.OPPOStartSettings;
import com.bkw.library.permission.menu.VIVOStartSettings;
...
public class PermissionUtils {
    ...
    public static void startAndroidSettings(Context context) {
        ...
        try {
            ...
            // 高层 面向抽象，而不是具体细节
            Intent intent = iMenu.startActivity(context);
